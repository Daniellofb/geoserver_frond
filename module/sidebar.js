    ...
    var data = [
        ...
        new ol.layer.Image({
            ...
            source: new ol.source.ImageWMS({
                ratio: 1,
                params: { LAYERS: 'show:0' },
                url: 'http://cartografia.xalapa.gob.mx/geoserver/colonias_poligonos/wms?service=WMS&version=1.1.0&request=GetMap&layers=colonias_poligonos:olonias_poligonos&bbox=713070.5210811349,2155983.6202275706,727856.8402272151,2167101.511132997&width=768&height=577&srs=EPSG:32614&styles=&format=image/png',
                serverType: 'geoserver'
            })
        })
    ];
